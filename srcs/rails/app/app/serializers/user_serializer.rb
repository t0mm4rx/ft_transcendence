class UserSerializer < ActiveModel::Serializer
  attributes :id, :username, :login, :avatar_url, :ladder_score, :ladder_ranking, :wins, :losses, :relation_to_user, :status, :tfa, :otp_secret_key, :admin, :blocked, :guild_id, :guild_owner, :guild_officer, :guild_invites, :guild_locked, :banned, :find_higher_ranked_user, :title, :pending_games
