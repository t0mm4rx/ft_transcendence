class UserSerializer < ActiveModel::Serializer
  attributes :id, :username, :login, :avatar_url, :wins, :losses, :relation_to_user, :online, :tfa, :otp_secret_key, :admin, :blocked, :guild_id, :guild_owner, :guild_officer, :guild_invites, :guild_locked
